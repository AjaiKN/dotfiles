 ...
 (tx "neovim/nvim-lspconfig"
     {:dependencies
      ...
      (fn []
        ...
        (vim.api.nvim_create_autocmd :LspAttach
          {:group (vim.api.nvim_create_augroup :kickstart-lsp-attach {:clear true})
           ...
           (fn [event]
             ...
             (local client-supports-method
               (fn [client method bufnr]
             ...
             (when (and client (client-supports-method client vim.lsp.protocol.Methods.textDocument_documentHighlight event.buf))
               (local highlight-augroup (vim.api.nvim_create_augroup :kickstart-lsp-highlight {:clear false}))
             ...
             (when (and client (client-supports-method client vim.lsp.protocol.Methods.textDocument_inlayHint event.buf))
               (map :<leader>th
                    (fn []
        ...
        (local capabilities (vim.tbl_deep_extend :force capabilities
        ...
        (local servers
          {;; :clangd {}
           ...
           :lua_ls {;; :cmd [...]
                    ;; :filetypes [...]
                    ;; :capabilities {}
                    :settings {:Lua {;; You can toggle below to ignore Lua_LS's noisy `missing-fields` warnings
        ...
        (vim.list_extend ensure-installed [;; Used to format Lua code
                                            :stylua])
