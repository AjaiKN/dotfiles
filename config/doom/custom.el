...
(custom-set-faces
 ...
 '(ediff-current-diff-A ((t (:inherit ediff-even-diff-A :background "darkgreen"))))
 '(ediff-current-diff-Ancestor ((t (:inherit ediff-current-diff-A))))
 '(ediff-even-diff-A ((t (:inherit hl-line :background "black" :box (:line-width (1 . 1) :color "lightgreen" :style flat-button)))))
 '(ediff-even-diff-Ancestor ((t (:background "dim grey" :distant-foreground "White"))))
 '(ediff-fine-diff-A ((t (:inherit ediff-even-diff-A :extend t :background "#234abf" :weight bold))))
 ...
 '(whitespace-empty ((t (:extend t :background "#63272e"))))
 '(whitespace-indentation ((t (:underline (:color "red" :style dots :position nil)))))
 '(whitespace-tab ((t (:background "#43272f" :foreground "#3f444a")))))
