...
(cl-defun akn/known-project-roots-above (&optional (file (or buffer-file-name default-directory)))
  (let ((home-dir (concat (akn/tramp-home-dir file) "/")))
    (cl-loop for root in projectile-known-projects ; (project-known-project-roots)
             ...
             collect root)))
(cl-defun akn/projectile-root-assume-cached (&optional (file (or buffer-file-name default-directory)))
...
(cl-defun akn/projectile-invalidate-cached-project-roots (&optional (file (or buffer-file-name default-directory)))
  (interactive)
