...
config.keys = {
  ...
  bind('SUPER', 'z', if_kkp(act.SendKey{ mods = 'SUPER', key = 'z' }, act.SendKey{ mods = 'CTRL', key = '/' })),
  -- bind('SHIFT|SUPER', 'Z', if_kkp(act.SendKey{ mods = 'SHIFT|SUPER', key = 'Z' }, act.Multiple{ act.SendKey{ mods = 'CTRL', key = 'x' }, act.SendKey{ mods = 'CTRL', key = 'y' } })),
  bind('SHIFT|SUPER', 'Z', if_kkp(act.SendKey{ mods = 'SHIFT|SUPER', key = 'Z' }, act.SendKey{ mods = 'SHIFT|CTRL|ALT', key = '_' })),
  bind('SUPER', 'f',
       if_kkp(kkp_super('f'),
